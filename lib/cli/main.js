...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `richcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ richcore-node add wallet-service');
      console.log('    $ richcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ richcore-node remove wallet-service');
      console.log('    $ richcore-node remove insight-api');
      console.log();
    });
